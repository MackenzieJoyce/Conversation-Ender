...
// Having a "0" at the front of the binary throws an error from eslint
// Good Ends --> 3##### 
// Bad Ends --> 7##### 
...
const promptsAndChoices = [
    ...
    choices: [
      {
        ...
        // Ellipse
        nextText: 70110010101101100011011000110100101110000011100110110010100001010
      },
      {
        text: 'Um... no.',
        requiredState: (currentState) => currentState.pokemon,
    ...
    choices: [
      {
        ...
        nextText: 3011100110111011101100101011000010111010001111001
      }
    ]
  },
  {
    ...
    choices: [
      {
        ...
        // Next Time
        nextText: 3011011100110010101111000011101000010000001110100011010010110110101100101
      },
      {
        text: 'Psh! Yeah I bet you do...',
        // Slut
        nextText: 701110011011011000111010101110100
      }
    ]
  },
  {
  ...
  {
    // Sweaty --> Restart
    id: 3011100110111011101100101011000010111010001111001,
  ...
  {
    // Slut --> BSOD
    id: 701110011011011000111010101110100,
  ...
  },
  {
    ...
    id: 3011011100110010101111000011101000010000001110100011010010110110101100101,
    text: 'maybe ill tell you next time',
    choices: [
      {
        text: 'What do you mean?',
        // Log Out Safe
        nextText: 301101100011011110110011101101111011101010111010001110011011000010110011001100101
      }
    ]
  },
  {
    // Ellipse Fatal --> Log Out Fatal
    id: 70110010101101100011011000110100101110000011100110110010100001010,
    text: '...',
    choices: [
      {
        text: 'hello?',
        ...
        // Log Out Fatal
        nextText: 70110110001101111011001110110111101110101011101000110011001100001011101000110000101101100
      },
      {
  ...
  },
  {
    ...
    id: 70110110001101111011001110110111101110101011101000110011001100001011101000110000101101100,
  ...
  },
  {
    ...
    id: 301101100011011110110011101101111011101010111010001110011011000010110011001100101,
    text: '*user has logged out*',
    choices: [
      {
